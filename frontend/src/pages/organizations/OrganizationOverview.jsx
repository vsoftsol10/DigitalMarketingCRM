...
export default function OrganizationOverview() {
  ...
  useEffect(() => {
    ...
    // ==========================================================
    // FACEBOOK - RECONNECT SUCCESS
    // ==========================================================

    if (socialConnect === "reconnect_success" && platform === "facebook") {
      setConnectingPlatform(null);

      showSuccess("Facebook Page reconnected successfully.");
    ...
    // ==========================================================
    // INSTAGRAM - RECONNECT SUCCESS
    // ==========================================================

    if (instagramOAuth === "reconnect_success") {
      setConnectingPlatform(null);

      showSuccess("Instagram account reconnected successfully.");
  ...
  const handleContinueSocialReconnect = async (platform) => {
    if (!organizationId || !socialReconnectAccount?.id) {
      return;
    }
    ...
    try {
      ...
      if (platform === "facebook") {
        await metaService.startOAuth(organizationId, {
          action: "reconnect",
          socialAccountId: socialReconnectAccount.id,
        });
